		...
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			<div className="m-4 sm:m-6 flex-1">
				...
				<ul className="flex mt-6 justify-center md:justify-start space-x-4">
					...
					<li>
						<a href="https://github.com/Mehraj001"><GitHub /></a>
					</li>
					<li>
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					<li className="flex items-center">
						...
						<span>221b Baker St, Noida Delhi, India</span>
					</li>					
					<li className="flex items-center">
						<Phone className="w-5 h-5 mr-2" />
						<span>+91 8979066955</span>
					</li>					
					<li className="flex items-center">
						<Mail className="w-5 h-5 mr-2" />
						<a href="mehrajalikhan74@gmail.com" target="_blank">
						mehrajalikhan74@gmail.com
						</a>
					</li>
					<li className="flex items-center">
